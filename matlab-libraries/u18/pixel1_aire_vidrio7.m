...
path_images = 'C:\Users\Admin\Documents\fisica\experimento usb\lab\capturas-110123-aire-vidrio7\capturas\';
...
hold on
for n = 1:size(m,2)
    plot(x_timestamp, smooth(double(m(:,n)),160)/max(smooth(double(m(:,n)),160))*250,'-','color',colors{1},'linewidth',2)
end
