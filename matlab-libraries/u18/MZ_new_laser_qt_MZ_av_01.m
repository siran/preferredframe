...
path_images = 'C:\Users\AMR\Documents\fisica\20140524-mz-av-franjasfinas-01\capturas\';
...
for i=1:(maxfiles)
    ...
    [imagenbw map]= imread(full_name_image);
%      imagen = rgb2gray(imagen);
%      imagenbw = imrotate(imagen, 0);
...
ti = nan;
t0 = input('si lo desea, especifique el punto de comienzo con un datatip, exportela como ti y presione [enter]');
if exist('ti')
