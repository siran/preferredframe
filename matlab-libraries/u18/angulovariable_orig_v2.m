...
doppler_aire = 1+((k_theta_aire  *n_aire  )/c).^(-1) - v*cos(theta)./((k_theta_aire  *n_aire  ).^2)/c
doppler_vidrio = 1+((k_theta_vidrio*n_vidrio)/c).^(-1) - v*cos(theta)./((k_theta_vidrio*n_vidrio).^2)/c

c_theta_aire   = ((k_theta_aire  *n_aire  )/c).^(-1) - v*cos(theta)./((k_theta_aire  *n_aire  ).^2) + lambda*doppler_aire/n_aire*dndl;
c_theta_vidrio = ((k_theta_vidrio*n_vidrio)/c).^(-1) - v*cos(theta)./((k_theta_vidrio*n_vidrio).^2) + lambda*doppler_vidrio/n_vidrio*dndl;
