...
videoId = 'M2U00302';
pathToVideo = 'C:\Users\an\Documents\fisica\michelson-morley\robert\150517 - young 6\';
...
frameToTime = [1789 datenum('9-mar-2015 19:36:00')];
...
% maxfiles = 30833; % ajuste manual pq video esta loco
...
%     imagen = imrotate(imagen, 0);     
    imagen = imfilter(imagen,fspecial('gaussian',15,5));
      
        perfil = imagen(199, 327:718);
