...
path_images = 'C:\Users\AMR\Documents\fisica\20140529-mz-vv-franjasfinas-02\capturas\';
...
%      imagen = rgb2gray(imagen);
    imagen = imfilter(imagen,fspecial('gaussian',20,6));
     imagenbw = imrotate(imagen, 25);
