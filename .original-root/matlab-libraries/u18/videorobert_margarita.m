...
xyloObj = VideoReader('C:\Users\an\Documents\fisica\michelson-morley\robert\140820 robert margarita\M2U00205.avi');
...
for i=1:(maxfiles)
    ...
    imagen = imfilter(imagen,fspecial('gaussian',20,30));
      
    perfil = imagen(371, 263:613);
