...
path_images = 'C:\Users\Admin\Documents\fisica\experimento usb\lab\capturas-aire-aire-30-TW4\capturas\';
...
for i=1:(maxfiles)
    ...
    [imagen map]= imread(full_name_image);
     ...
     imagenbw = imrotate(imagenbw, 35);
       

    
%     imagen = imagen.' ;
      
    perfil = imagenbw(161,144:359);
