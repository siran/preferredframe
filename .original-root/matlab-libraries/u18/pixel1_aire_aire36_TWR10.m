...
path_images = 'C:\Users\Admin\Documents\fisica\experimento usb\lab\capturas-110902-aire-aire-TWR10\capturas\';
...
for i=1:(maxfiles)
    ...
    [imagen map]= imread(full_name_image);
     ...
     imagenbw = imrotate(imagenbw, 30);
       

    
%     imagen = imagen.' ;
      
    perfil = imagenbw(220,109:340);
