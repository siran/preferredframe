...
set(gca,'XTick',startDate:6/24:endDate+4/24)
...
fechaCenitP = datenum('2011-03-01 23:48'); %aqui esta en el oeste
fechaOeste = datenum('2011-03-02 06:02'); %aqui esta en el oeste
fechaCenitN = datenum('2011-03-02 12:25'); %aqui esta en el oeste
