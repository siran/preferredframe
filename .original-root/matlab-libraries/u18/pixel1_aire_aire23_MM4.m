...
path_images = 'C:\Users\Admin\Documents\fisica\experimento usb\lab\capturas-aire-aire-23-MM4\capturas\';
...
%     imagen = imagen.' ;
    ...
    perfil = imagenbw(175,119:491);
    perfil = double(perfil);
    perfil=smooth(perfil,20);
% 
    perf = perfil;
%     xd = 1:size(perfil);
