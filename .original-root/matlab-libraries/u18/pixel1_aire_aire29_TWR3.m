...
path_images = 'C:\Users\Admin\Documents\fisica\experimento usb\lab\capturas-aire-aire-29-TW3\capturas\';
...
for i=1:(maxfiles)
    ...
    [imagen map]= imread(full_name_image);
     ...
     imagenbw = imrotate(imagenbw, 45);
       

    
%     imagen = imagen.' ;
      
    perfil = imagenbw(208,84:384);
